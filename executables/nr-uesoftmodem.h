...
#define  CONFIG_HLP_SKIP_RACH              "Skip RACH procedure during handover reconfiguration\n"
...
#define CMDLINE_NRUEPARAMS_DESC {  \
  ...
  {"skip-rach",                    CONFIG_HLP_SKIP_RACH,       PARAMFLAG_BOOL,  .iptr=&(nrUE_params.skip_rach),              .defintval=0,      TYPE_INT,      0}, \
}
// clang-format on
